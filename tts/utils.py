...
def load_frontends(speech_tokenizer, sample_rate=24000, use_phoneme=False, frontend_dir="frontend", model_dir='ckpt', DEVICE='cuda:0'):
...
def load_models(use_phoneme=False, sample_rate=24000, model_dir='ckpt', vocos=True, DEVICE='cuda:0'):
    ...
    # Load Frontends
    frontend, text_frontend = load_frontends(speech_tokenizer, sample_rate=sample_rate, use_phoneme=use_phoneme, model_dir=model_dir, DEVICE=DEVICE)
